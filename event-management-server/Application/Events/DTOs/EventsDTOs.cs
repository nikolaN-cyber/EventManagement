...
public record CreateEventQuery(string Name, DateTime DateAndTime, string Location, byte[]? Image, string Description) : IRequest<Result<EventResponse>>;
...
public record EventResponse(int Id, string Name, DateTime DateAndTime, string Location, byte[]? Image, string Description, int OrganizerId);
